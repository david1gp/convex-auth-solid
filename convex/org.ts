...
export const orgCreateMutation = mutation({
  ...
  handler: async (ctx, args) => {
    return authMutation(ctx, args, orgCreateFn)
  },
})
...
export const orgEditMutation = mutation({
  ...
  handler: async (ctx, args) => {
    return await authMutationR(ctx, args, orgEditFn)
  },
})
...
export const orgGetQuery = query({
  ...
  handler: async (ctx, args) => {
    return await authQueryR(ctx, args, orgGetFn)
  },
})
...
export const orgsListQuery = query({
  ...
  handler: async (ctx, args) => {
    return await authQuery(ctx, args, orgListFn)
  },
})
...
export const orgDeleteMutation = mutation({
  ...
  handler: async (ctx, args) => {
    return authMutation(ctx, args, orgDeleteFn)
  },
})
...
export const orgMemberEditMutation = mutation({
  ...
  handler: async (ctx, args) => {
    return await authMutationR(ctx, args, orgMemberEditFn)
  },
})
...
export const orgMembersListQuery = query({
  ...
  handler: async (ctx, args) => {
    return await authQuery(ctx, args, orgMemberListFn)
  },
})
...
export const orgMemberDeleteMutation = mutation({
  ...
  handler: async (ctx, args) => {
    return authMutation(ctx, args, orgMemberDeleteFn)
  },
})
