...
const OrgListPage = lazy(() =>
  import("#src/org/org_ui/list/OrgListPage.tsx").then((c) => ({
    default: c.OrgListPage,
  })),
)
const OrgEditPage = lazy(() =>
  import("#src/org/org_ui/mutate/OrgEditPage.tsx").then((c) => ({
    default: c.OrgEditPage,
  })),
)
const OrgViewPage = lazy(() =>
  import("#src/org/org_ui/view/OrgViewPage.tsx").then((c) => ({
    default: c.OrgViewPage,
  })),
)
const OrgAddPage = lazy(() =>
  import("#src/org/org_ui/mutate/OrgAddPage.tsx").then((c) => ({
    default: c.OrgAddPage,
  })),
)
const OrgRemovePage = lazy(() =>
  import("#src/org/org_ui/mutate/OrgDeletePage.tsx").then((c) => ({
    default: c.OrgDeletePage,
  })),
)
const OrgLeavePage = lazy(() =>
  import("#src/org/org_ui/mutate/OrgLeavePage.tsx").then((c) => ({
    default: c.OrgLeavePage,
  })),
)
