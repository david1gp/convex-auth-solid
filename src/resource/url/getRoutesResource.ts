...
const ResourceListPage = lazy(() =>
  import("#src/resource/ui/list/ResourceListPage.tsx").then((c) => ({
    default: c.ResourceListPage,
  })),
)
const ResourceEditPage = lazy(() =>
  import("#src/resource/ui/mutate/ResourceEditPage.tsx").then((c) => ({
    default: c.ResourceEditPage,
  })),
)
const ResourceViewPage = lazy(() =>
  import("#src/resource/ui/view/ResourceViewPage.tsx").then((c) => ({
    default: c.ResourceViewPage,
  })),
)
const ResourceAddPage = lazy(() =>
  import("#src/resource/ui/mutate/ResourceAddPage.tsx").then((c) => ({
    default: c.ResourceAddPage,
  })),
)
const ResourceRemovePage = lazy(() =>
  import("#src/resource/ui/mutate/ResourceDeletePage.tsx").then((c) => ({
    default: c.ResourceDeletePage,
  })),
)
