...
const WorkspaceListPage = lazy(() =>
  import("#src/workspace/ui/list/WorkspaceListPage.tsx").then((c) => ({ default: c.WorkspaceListPage })),
)
const WorkspaceEditPage = lazy(() =>
  import("#src/workspace/ui/mutate/WorkspaceEditPage.tsx").then((c) => ({ default: c.WorkspaceEditPage })),
)
const WorkspaceViewPage = lazy(() =>
  import("#src/workspace/ui/view/WorkspaceViewPage.tsx").then((c) => ({ default: c.WorkspaceViewPage })),
)
const WorkspaceAddPage = lazy(() =>
  import("#src/workspace/ui/mutate/WorkspaceAddPage.tsx").then((c) => ({ default: c.WorkspaceAddPage })),
)
const WorkspaceRemovePage = lazy(() =>
  import("#src/workspace/ui/mutate/WorkspaceDeletePage.tsx").then((c) => ({ default: c.WorkspaceDeletePage })),
)
