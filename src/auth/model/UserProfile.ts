import { userRoleSchema, type UserRole } from "#src/auth/model_field/userRole.js"
import { userRoleValidator } from "#src/auth/model_field/userRoleValidator.js"
import { orgRoleSchema, type OrgRole } from "#src/org/org_model_field/orgRole.js"
...
import type { HasCreatedAtUpdatedDeletedAt } from "#src/utils/data/HasCreatedAtUpdatedDeletedAt.js"
